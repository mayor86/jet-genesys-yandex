...
class View11 extends View {
  constructor(handler, state) {
    ...
    this._state = state;
    this._adaptText = this._state.chosenProduct === 'Subscription' ? `В таком случае, мне понадобятся только ваши ФИО и логин на Яндексе.
Продиктуйте, пожалуйста. Записал.
Я подготовлю ссылку для оплаты и отправлю ее на Вашу почту. На какую почту могу написать? Ссылка придет в течение 10 минут.
А пока давайте резюмируем наш диалог: Ваша компания ${this._state.company}, с видом деятельности ${this._state.branch}, предоставляет услуги по адресу ${this._state.address}, будет продвигаться с помощью Рекламной подписки на Яндекс, все верно?
${this._state.lpr}, когда ждать поступления?
Через 5-7 дней после старта рекламной кампании с Вами свяжется наш аккаунт-менеджер. Он будет помогать Вам на всем периоде размещения по Рекламной Подписке` : this._state.chosenProduct === 'maps' ? `В таком случае, мне понадобятся только ваши ФИО и логин на Яндексе. Продиктуйте, пожалуйста. Записал.
Я подготовлю ссылку для оплаты и отправлю ее на Вашу почту. На какую почту могу написать? Ссылка придет в течение 10 минут.
А пока давайте резюмируем наш диалог: Ваша компания ${this._state.company}, с видом деятельности ${this._state.branch}, предоставляет услуги по адресу ${this._state.address}, будет
продвигаться с помощью Рекламного размещения на Яндекс.Картах, все верно?
${this._state.lpr}, когда ждать поступления?
Через 5-7 дней после старта рекламной кампании с Вами свяжется наш аккаунт-менеджер. Он будет помогать Вам на всем периоде размещения на Яндекс картах.`
    : 
    `{В таком случае, мне понадобятся только ваши ФИО и логин на Яндексе. Продиктуйте, пожалуйста. Записал.
Я подготовлю ссылку для оплаты и отправлю ее на Вашу почту. На какую почту могу написать? Ссылка придет в течение 10 минут.
...
${this._state.lpr}, когда ждать поступления?
Через 5-7 дней после старта рекламной кампании с Вами свяжется наш аккаунт-менеджер. Он будет помогать Вам на всем периоде размещения по Рекламной Подписке / на Яндекс.Картах.`;
...
<textarea class="workspace__info workspace__info_size_300" disabled>${this._adaptText}</textarea>
